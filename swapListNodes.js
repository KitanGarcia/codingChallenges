...
//create a function to swap the first occurence of the locations of two nodes in the list
//a is value of first node to be swapped. b is value of 2nd node to be swapped
//return ListNode
function swapNodes(node, a, b) {
